...
const STRINGS = {
  ...
  'floor.circuitHint': {
    ...
    fr: 'Le temps de marche est imputé au temps disponible du poste lié — il baisse son TRS, sa capacité et tout le flux.',
  },
  'floor.purpose.delivery': { en: 'Deliver production to next step', fr: 'Livrer la production à l’étape suivante' },
  ...
  'station.circuit': { en: 'circuit', fr: 'circuit' },
  'station.onFloorTime': { en: 'Operator present', fr: 'Opérateur présent' },
  'station.circuitLoss': { en: 'Operator circuits', fr: 'Circuits opérateur' },
